...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__create_match__ = __webpack_require__(856);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(852)(module)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_moment__ = __webpack_require__(728);
...
var CreateMatchPage = /** @class */ (function (_super) {
    ...
    CreateMatchPage.prototype.onUserChange = function (user) {
        ...
        if (user != null) {
            ...
            var teamsRef = this.afoDatabase.list("/users/" + this.authService.user.uid + "/teams");
            teamsRef.subscribe(function (items) {
                items.forEach(function (item) {
    ...
    CreateMatchPage.prototype.openTeamAlert = function () {
        var _this = this;
        var list = [{
                type: 'radio',
        ...
        prompt.addButton({
            ...
            handler: function (data) {
                ...
                if (data == 'new') {
                    ...
                    _this.teamHomeEnabled = false;
                    _this.teams.forEach(function (team) {
                        if (team.id == data) {
                            _this.teamA = team.name;
                        }
                    });
                    _this.teamId = data;
                }
