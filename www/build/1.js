...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(809)(module)))
...
var CreateMatchPage = /** @class */ (function (_super) {
    ...
    function CreateMatchPage(navCtrl, navParams, events, authService, alertCtrl, platform, afoDatabase) {
        ...
        events.subscribe("create-match", function (page) {
            ...
            if (_this.teamA == undefined ||
                _this.teamA.trim() == "" ||
                _this.teamB == undefined ||
                _this.teamB.trim() == "") {
                _this.errorPopup("Dati mancanti", "Inserisci entrambi i nomi delle squadre in gioco");
            }
            else {
                if (_this.authService.user != null) {
                    var newGameRef = _this.games.push({});
                    ...
                    _this.openLiveMatch(newGameRef.key, _this.teamA, _this.teamB);
                }
            }
        });
        return _this;
